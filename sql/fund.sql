...
CREATE TABLE `fund_daily_state`  (
  ...
  `value` decimal(10, 6) NULL DEFAULT NULL COMMENT '单位净值',
  `total_value` decimal(10, 6) NULL DEFAULT NULL COMMENT '累计净值',
  `bonus` decimal(16, 12) UNSIGNED ZEROFILL NULL DEFAULT NULL COMMENT '分红',
  `bonus_des` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '分红描述',
  `redemption` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '开放赎回状态 【暂停，开放】',
  `purchase` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '开放申购状态  【暂停，开放，限大额】',
  `increase_rate` decimal(10, 4) NULL DEFAULT NULL COMMENT '日增长率',
  `raw_state` tinyint(1) NULL DEFAULT 0 COMMENT '原始数据是否异常，1：异常，0：正常',
...
CREATE TABLE `fund_info`  (
  ...
  `updated_at` date NULL DEFAULT NULL COMMENT '更新日期',
